    ...
    <div class="confirm__content">
      ...
      @csrf
          ...
          <table class="confirm-table__inner">
            <tr class="confirm-table__row">
              ...
              <td class="confirm-table__text">
                <input type="text" name="name"  value="{{ $contact['first-name' ] }}  {{ $contact['last-name']}}"/>
        ...
        <div class="form__button" >
          <button class="form__button-submit" type="submit" action="/contacts" method="post">送信</button>
          <a href="/">修正</a>>  
        </div>
      </form>
    </div>
